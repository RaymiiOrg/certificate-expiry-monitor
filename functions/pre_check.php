...
function add_domain_to_pre_check($domain, $email, $visitor_ip)
{
    ...
    $message = "Hello,\r\n\r\nSomeone, hopefully you, has added his website to the " . $title . ". This is a service which monitors an SSL certificate on a website, and notifies you when it is about to expire. This extra notification helps you remember to renew your certificate on time.\r\n\r\nIf you have subscribed to this check, please click the link below to confirm this subscription. If you haven't subscribed to the " . $title . " service, please consider this message as not sent.\r\n\r\n\r\nDomain: " . trim(htmlspecialchars($domain)) . "\r\nEmail: " . trim(htmlspecialchars($email)) . "\r\nIP subscribed from: " . htmlspecialchars($visitor_ip) . "\r\nDate subscribed: " . date("Y-m-d H:i:s T") . "\r\n\r\nPlease click or copy and paste the below link in your browser to subscribe: \r\n\r\n" . $sublink . "\r\n\r\n\r\nHave a nice day,\r\nThe " . $title ." Service.";
